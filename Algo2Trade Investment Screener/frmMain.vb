...
#End Region
    ...
    Private Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        If dgrvMain IsNot Nothing AndAlso dgrvMain.Rows.Count > 0 Then
            ...
            saveFile.FileName = String.Format("Investment Stock List {0} to {1}.csv", GetDateTimePickerValue_ThreadSafe(dtpckrFromDate).ToString("dd_MM_yy"), GetDateTimePickerValue_ThreadSafe(dtpckrToDate).ToString("dd_MM_yy"))
    ...
    Private Async Function StartProcessing() As Task
        Try
            ...
            Dim runningRule As Rule = Nothing

            Select Case procedureToRun
                Case 0
                    runningRule = New SMA200Rule(_canceller)
            End Select
            ...
            dt = Await runningRule.RunAsync(startDate.Date, endDate.Date).ConfigureAwait(False)
            SetDatagridBindDatatable_ThreadSafe(dgrvMain, dt)
        Catch cx As OperationCanceledException
            MsgBox(cx.Message, MsgBoxStyle.Critical)
